...
<body>
    ...
    <div class="divform">
        <form class="formulario" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="input_contenedor"> <label for=""> <i class="bi bi-person"></i>
            ...
            <div class="message_error"> <?php include("../errores.php");
                                        echo $_SESSION['usuario_error'];
                                        $_SESSION['ContraseñaError']  = ""    ?>
            </div>
            ...
            <div class="message_error">
                ...
                echo $_SESSION['ContraseñaError2'];
                $_SESSION['ContraseñaError2']  = ""    ?>
            </div>
            ...
            <div class="message_error">
                <?php include("../errores.php");
                echo $_SESSION['VerificacionError2'];
                $_SESSION['VerificacionError2']  = ""    ?>
            </div>
            ...
            <div class="input_contenedor_img"> <img width="140px" class="fdp" id="imagenPrevisualizacion">
            </div>
